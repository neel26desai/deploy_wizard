...
class MyOpenAI(Talker):
    FILE_WITH_SECRET = 'C:/Users/ruchi/Downloads/azure_vm_deploy_wizard/OpenAIDeployWizardKey.txt'
    ...
    def read_openai_key(self):
        try:
            ...
            raise RuntimeError(f"❌ API Key file NOT found at {self.FILE_WITH_SECRET}")
